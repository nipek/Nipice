...
public class CordovaWebViewImpl implements CordovaWebView {
    ...
    class C00182 implements Runnable {
        ...
        C00182(int i, int i2, Runnable runnable) {
    ...
    class C00193 implements Runnable {
        ...
        C00193(int i, Runnable runnable, String str, boolean z) {
            this.val$loadUrlTimeoutValue = i;
    ...
    protected class EngineClient implements Client {
        ...
        class C00211 implements Runnable {
            ...
            public void run() {
                try {
                    Thread.sleep(2000);
                    CordovaWebViewImpl.this.cordova.getActivity().runOnUiThread(new C00201());
                } catch (InterruptedException e) {
                }
            }
        }
    ...
    public void loadUrlIntoView(String url, boolean recreatePlugins) {
        ...
        this.cordova.getActivity().runOnUiThread(new C00193(loadUrlTimeoutValue, new C00182(loadUrlTimeoutValue, currentLoadUrlTimeout, new C00171(url)), url, recreatePlugins));
    }
